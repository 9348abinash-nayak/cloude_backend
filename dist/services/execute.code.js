...
import { languageMap } from "../utils/language.version.js";
import { Room } from "../model/room.model.js";
import dotenv from "dotenv";
dotenv.config();
const BASE_URL = "https://ce.judge0.com";
export const executeCodeService = async (data) => {
    try {
        ...
        const response = await axios.post(`${BASE_URL}/submissions?base64_encoded=true&wait=true`, {
